...
DocMeta.setdocmeta!(XDave, :DocTestSetup, :(using XDave); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaXRTS/XDave.jl/blob/{commit}{path}#{line}",
    sitename = "XDave.jl",
    format = Documenter.HTML(; canonical = "https://JuliaXRTS.github.io/XDave.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaXRTS/XDave.jl")
